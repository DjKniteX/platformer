...
local buffBoss = Class{
  __includes = Entity -- Player class inherits our Entity class
}

function buffBoss:init(world, x, y)
  self.img = love.graphics.newImage('/assets/Super Strong Normal Guy/Strong Guy Idle/Strong_Guy_Idle_Spritesheet.png')
  for y = 1, 1 do
    for x = 1, 1 do
      table.insert(frames, love.graphics.newQuad(18 * x - 18, 18 * y - 18, 18, 23, self.img:getDimensions()))
    end
  end

  

  Entity.init(self, world, x, y, 18, self.img:getHeight())
...
function buffBoss:collisionFilter(other)
